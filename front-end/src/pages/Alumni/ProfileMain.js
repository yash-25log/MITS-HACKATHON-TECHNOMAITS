...
export default function Profile() {
  ...
  console.log("profile main", user);

  {
    //  user.data!==null
    // console.log("Name Old=> ", user.data.User.Name);
  }
  if (user.data != null) {
    console.log("Name => ", user.data.User.Name);
  }
  // console.log("Name New=> ", user.data.user[0].Name);
  ...
  return (
    <div
      style={{
        ...
        width: "1150px",
        height: "715px",
        boxShadow: "0px 2px 30px 2px lightGray",
      }}
    >
      <div
        style={{
      ...
      >
        ...
        />
        <img
          style={{ width: "171px", height: "171px", borderRadius: "100px" }}
        ...
        <div style={{ marginLeft: "45px", marginTop: "13px" }}>
          <p
            style={{ fontSize: "35px", fontWeight: "600", marginBottom: "1px" }}
          >
            {/* {name} */}
            Sahil
          </p>
          <p
            style={{ fontSize: "20px", marginBottom: "2px", fontWeight: "550" }}
          >
            Founder and CEO @...
          </p>
          <p style={{ fontSize: "17px" }}>
            <GrLocation /> New Delhi , India
          </p>
        </div>
      ...
      >
        <h2
          style={{ marginLeft: "10px", marginBottom: "2px", color: "#101727" }}
        >
          Bio :{" "}
        </h2>
        <p style={{ fontSize: "18px", marginLeft: "10px" }}>
          Hi , I am Sahil , currently working at Amazon as SDE 2
        </p>
      </div>
      ...
      >
        ...
        >
          <p
            style={{ fontSize: "18px", fontWeight: "400", marginLeft: "20px" }}
          >
            {" "}
            <p
              style={{
        ...
        >
          <h2 style={{ color: "#101727" }}>Qualification : </h2>
          <p>B.Tech in Information Technology</p>
          <p>
            {" "}
            <span>Year of Passing </span> : 2025
          </p>
        </div>
      </div>
    </div>
